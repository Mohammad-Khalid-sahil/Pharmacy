...
class SaleControllers {
  ...
  /**
   * Create bulk sale (POS)
   */
  createBulk = asyncHandler(async (req, res) => {
    const result = await this.services.createBulk(req.body, req.user._id);
  ...
  /**
   * Get sale group by transaction
   */
  readByTransaction = asyncHandler(async (req, res) => {
    const result = await this.services.readByTransaction(req.params.transactionId, req.user._id);
  ...
  update = asyncHandler(async (req, res) => {
    ...
    const result = await this.services.updateSale(req.params.id, restPayload, req.user._id);
  ...
  deleteSale = asyncHandler(async (req, res) => {
    await this.services.deleteSale(req.params.id, req.user._id);

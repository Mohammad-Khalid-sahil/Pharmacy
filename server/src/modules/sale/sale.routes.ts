...
saleRoutes.get('/transaction/:transactionId', saleControllers.readByTransaction);
saleRoutes.post('/', validateRequest(saleValidator.createSchema), saleControllers.create);
saleRoutes.post('/bulk', validateRequest(saleValidator.bulkCreateSchema), saleControllers.createBulk);
...
saleRoutes.delete('/:id', saleControllers.deleteSale);
